var produtcs=[
  ...
  // var title= produtcs.map(o=>o.title)
  // console.log(title);

  // produtcs.filter(o=>o.category=="electronics").forEach(p=>console.log(p.title))
  produtcs.filter(o=>o.category=="jewelery" && o.rating.rate>3).forEach(p=>console.log(p.title))